...
private:
    ...
    public:
        ...
        item(item * parentItem, sACNSyncListModel * parentModel)
            : QObject(parentModel), m_parentModel(parentModel), m_parentItem(parentItem)
        {}
        virtual ~item();
    ...
    protected:
        ...
        item(item * parentItem)
            : QObject(parentItem->parentModel()), m_parentModel(parentItem->parentModel()), m_parentItem(parentItem)
        {}
    ...
    public:
        ...
        item_HelpMsg(messageMap_t & messages, item * parent)
            : item(parent), m_messages(messages)
        {}
    ...
    public:
        ...
        item_SyncAddress(tsyncAddress syncAddress, item * parent)
            : item(parent), m_syncAddress(syncAddress)
        {}
    ...
    public:
        ...
        item_SyncAddress_Synced_Universe(quint16 universe, item * parent)
            : item(parent), m_universe(universe)
        {}
...
public:
    ...
    public:
        ...
        proxy(QObject * parent = Q_NULLPTR)
