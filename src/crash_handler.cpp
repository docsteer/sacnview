...
namespace Breakpad
{
...
#endif
    {
        ...
        swprintf_s(
            message,
            512,
            L"Unfortunately sACNView encountered an error and needs to close.\r\nPlease sumbit a crash report with the "
            L"dump file located at %ls/%ls.dmp",
            _dump_dir,
            _minidump_id);
        MessageBox(NULL, message, (LPCWSTR)L"sACNView Fatal Error", MB_ICONERROR | MB_OK | MB_DEFBUTTON1);
