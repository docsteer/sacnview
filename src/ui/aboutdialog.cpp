    ...
    : QDialog(parent), ui(new Ui::aboutDialog)
{
    ...
    {
        ui->DisplayVer->setText(QString("%1\n%2").arg(VERSION, GIT_CURRENT_SHA1));
    }
    ui->displayDate->setText(QString("%1, %2 %3 %4").arg(GIT_DATE_DAY, GIT_DATE_DATE, GIT_DATE_MONTH, GIT_DATE_YEAR));
    ...
    for (const auto & translations : Translations::lTranslations)
    {
        ...
        {
            if (!translators.contains(translatorName)) translators << translatorName;
        }
    }
    ...
    ui->lblLicense->setText(
        tr("<p>This application is provided under the <a href=\"http://www.apache.org/licenses/LICENSE-2.0\">Apache "
           "License, version 2.0</a></p>"));

    {
        QString licence_string = tr(
            "Licensed under the <a href=\"http://www.gnu.org/licenses/lgpl.html\">GNU LGPL</a>");
        ...
        ui->lblQtInfo->setText(tr("<p>This application uses the Qt Library<br>"
                                  "Version %1<br>%2</p>")
...

    {
        ...
        {
            ui->lblLibs->setText(tr("<p>This application uses <a href=\"https://www.tcpdump.org/\">libpcap</a><br>"
                                    "%1<br>"
                                    "Licensed under the <a href=\"https://opensource.org/licenses/BSD-3-Clause\">The "
                                    "3-Clause BSD License</a></p>")
                                     .arg(QString::fromStdString(PcapPlayback::getLibPcapVersion())));
        }
        ui->lblLibs->setText(
            ui->lblLibs->text()
            + tr(
                "<p>This application uses <a href=\"https://www.blake2.net/\">BLAKE2</a><br>"
                "Licensed under the <a href=\"https://creativecommons.org/publicdomain/zero/1.0/\">Creative Commons "
                "Zero v1.0 Universal</a></p>"));
    }
...
{
    if (m_listenerModel) m_listenerModel->refresh();
}
