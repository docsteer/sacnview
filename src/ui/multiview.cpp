...
MultiView::MultiView(QWidget * parent)
    : QWidget(parent), ui(new Ui::MultiView), m_sourceTableModel(new SACNSourceTableModel(this))
{
    ui->setupUi(this);
    ...
    connect(
        ...
        m_sourceTableModel,
        &SACNSourceTableModel::setShortInterval);
    ...
    connect(
        ...
        QOverload<int>::of(&QSpinBox::valueChanged),
        m_sourceTableModel,
        &SACNSourceTableModel::setLongInterval);
    ...
    connect(
        ...
        QOverload<int>::of(&QSpinBox::valueChanged),
        m_sourceTableModel,
        &SACNSourceTableModel::setStaticInterval);

    // Maybe don't show the Secure column
    ui->sourceTableView->setColumnHidden(
