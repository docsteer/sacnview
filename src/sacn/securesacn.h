...
public:
    ...
    PathwaySecure() {}
    ~PathwaySecure() {}
    PathwaySecure(const PathwaySecure &) = delete;
    void operator=(const PathwaySecure &) = delete;
    ...
    /**
         ...
         */
    static bool VerifyStreamSecurity(const quint8 * pbuf, size_t buflen, password_t password, sACNSource & source);
    ...
    /**
         ...
         */
    static bool ApplyStreamSecurity(quint8 * pbuf, size_t buflen, const CID & cid, const password_t & password);
...
private:
    ...
    public:
        ...
        Sequence();
        ~Sequence();
        Sequence(const PathwaySecure &) = delete;
        ...
        public:
            ...
            /**
                     ...
                     */
            type getUpper() { return (data & UPPER_MASK) >> UPPER_SHIFT; }

            /**
                     * @brief Get the lower word of the value
                     * @return Lower range value
                     */
            type getLower() { return (data & LOWER_MASK) >> LOWER_SHIFT; }
            ...
            friend bool operator==(const value_t & l, const value_t & r) { return l.data == r.data; }
            friend bool operator!=(const value_t & l, const value_t & r) { return !(l == r); }
            friend QDataStream & operator<<(QDataStream & l, const value_t & r) { return l << r.data; }
